 ...
 *   WASD              — move
 *   LMB               — light attack (3-hit combo: attack → fist → strike)
 *   RMB               — heavy attack / bash / whirlwind
 *   Space             — jump / double jump
 *   Shift             — dash (300ms, can chain to dashAttack)
 *   1                 — block (hold for combos)
 *   2                 — launch (uppercut juggle)
 *   3                 — bash (keyboard alt for RMB)
 *   4                 — pop / special
 *   Block + ↓→LMB     — hadouken
 *   Block + →↓→LMB    — shoryuken
...
export default function AnnihilateDemo() {
  ...
  {/* Controls legend — Grudge standard keymap */ }
    ...
    <div><span className="text-white" > LMB < /span> Attack <span className="text-white ml-2">RMB</span > Bash / Whirlwind </div>
      < div > <span className="text-white" > Space < /span> Jump <span className="text-white ml-2">Shift</span > Dash </div>
        < div > <span className="text-white" > 1 < /span> Block <span className="text-white ml-2">2</span > Launch < span className = "text-white ml-2" > 3 < /span> Bash <span className="text-white ml-2">4</span > Special </div>
          < div > <span className="text-white" > Block + ↓→LMB < /span> Hadouken</div >
            <div><span className="text-white" > Block + →↓→LMB < /span> Shoryuken</div >
              <div><span className="text-white" > Block + ↓←Space < /span> Ajejebloken</div >
      </div>
