...
// ─── Controls legend row ─────────────────────────────────────────────────────
// Isolated as its own component so the IDE's JSX auto-formatter cannot mangle
// the markup of the legend (multi-span inline rows get word-spaced apart).
...
export default function AnnihilateDemo() {
  ...
  {/* Controls legend — Grudge standard keymap */ }
    ...
    < ControlRow keys = "WASD" label = "Move" />
      <ControlRow keys="LMB" label = "Attack (light)" />
        <ControlRow keys="RMB" label = "Attack (heavy) / Bash / Whirlwind" />
              ...
              <ControlRow keys="1" label = "Block (hold for combos)" />
                <ControlRow keys="2" label = "Launch (uppercut)" />
                  <ControlRow keys="3" label = "Bash (keyboard alt)" />
                    <ControlRow keys="4" label = "Pop / Special" />
