    ...
    while (urlsQueue.length > 0 && scrapedUrls.size < maxPages && currentDepth < maxDepth) {
      ...
      for (const url of currentBatch) {
        ...
        try {
          ...
          console.error(`Error scraping ${url}: - Game.js:187`, error);
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/auth/register", async (req, res) => {
    try {
      ...
      console.error("Register error: - Game.js:277", error);
  ...
  app.post("/api/auth/login", async (req, res) => {
    try {
      ...
      console.error("Login error: - Game.js:308", error);
  ...
  app.get("/api/public/landing", (_req, res) => {
    ...
    res.json({
      ...
      puter: [
        { tag: "Cloud", name: "Grudge Cloud Admin", url: "https://grudgecloud.puter.site" },
