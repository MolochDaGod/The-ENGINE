...
export const portalStats = {
  ...
  app.post("/api/auth/guest", async (_req, res) => {
    try {
      ...
      console.error("Guest signin error: - Game.js:478", error);
  ...
  app.post("/api/auth/complete-profile", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("Completeprofile error: - Game.js:507", error);
  ...
  app.post("/api/auth/phantom/verify", async (req, res) => {
    try {
      ...
      console.error("Phantom verify error: - Game.js:584", error);
  ...
  app.get("/api/auth/google/callback", async (req, res) => {
    try {
      ...
      console.error("Google callback error: - Game.js:683", error);
  ...
  app.get("/api/auth/github/callback", async (req, res) => {
    try {
      ...
      console.error("GitHub callback error: - Game.js:794", error);
  ...
  app.get("/api/auth/discord/callback", async (req, res) => {
    try {
      ...
      console.error("Discord callback error: - Game.js:891", error);
  ...
  app.post("/api/auth/twilio/start", async (req, res) => {
    try {
      ...
      if (!twilioConfigured()) {
        ...
        console.log(`[twilio:dev] OTP for ${normalized}: ${code} - Game.js:921`);
      ...
      if (!resp.ok) {
        ...
        console.error("[twilio] Verification API error: - Game.js:934", errBody);
      ...
      console.error("Twilio start error: - Game.js:941", error);
  ...
  app.post("/api/auth/twilio/verify", async (req, res) => {
    try {
      ...
      console.error("Twilio verify error: - Game.js:1003", error);
  ...
  app.post("/api/auth/popup-token", requirePlayer, (req, res) => {
    try {
      ...
      console.error("popuptoken error: - Game.js:1176", error);
  ...
  app.post("/api/auth/session/exchange", async (req, res) => {
    try {
      ...
      console.error("session/exchange error: - Game.js:1204", error);
  ...
  app.post("/api/auth/puter-sso", async (req, res) => {
    try {
      ...
      console.error("Puter SSO error: - Game.js:1260", error);
  ...
  app.post("/api/scores", requirePlayer, async (req, res) => {
    try {
      ...
      onScoreSubmitted({
        ...
        username: player.displayName || player.username,
        gameTitle: game.title,
      }).catch((err) => console.error("[rewardworker] Score reward failed: - Game.js:1333", err));

      return res.json({ ...newScore, isPersonalBest, isGlobalRecord });
    } catch (error) {
      console.error("Score submit error: - Game.js:1337", error);
  ...
  app.get("/api/leaderboards/global", async (req, res) => {
    try {
      ...
      console.error("/api/leaderboards/global error: - Game.js:1348", error);
  ...
  app.post("/api/challenges", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("Challenge create error: - Game.js:1437", error);
  ...
  app.post("/api/challenges/:id/result", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("Challenge result error: - Game.js:1578", error);
  ...
  app.post("/api/gbux/purchase", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("GBUX purchase error: - Game.js:1655", error);
  ...
  app.post("/api/gbux/spend", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("GBUX spend error: - Game.js:1694", error);
  ...
  app.post("/api/gbux/transfer", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("GBUX transfer error: - Game.js:1750", error);
  ...
  app.patch("/api/me/profile", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("PATCH /api/me/profile error: - Game.js:1830", error);
      return res.status(500).json({ error: "Failed to update profile" });
    }
  });
  ...
  app.get("/api/me/connections", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("GET /api/me/connections error: - Game.js:1862", error);
  ...
  app.post("/api/me/wallets", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("POST /api/me/wallets error: - Game.js:1913", error);
  ...
  app.get("/api/me/stats", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("/api/me/stats error: - Game.js:1951", error);
  ...
  app.get("/api/me/scores", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("/api/me/scores error: - Game.js:1963", error);
  ...
  app.get("/api/me/games", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("/api/me/games error: - Game.js:1974", error);
  ...
  app.get("/api/games/top", async (req, res) => {
    try {
      ...
      console.error("/api/games/top error: - Game.js:1986", error);
  ...
  app.post("/api/web3/disconnect", requirePlayer, async (req, res) => {
    try {
      ...
      console.error("Wallet disconnect error: - Game.js:2141", error);
  ...
  app.post("/api/launch-engine", async (req, res) => {
    try {
      ...
      console.log(`Launching ${engine}... - Game.js:2173`);
  ...
  app.post("/api/open-project", async (req, res) => {
    try {
      ...
      console.log(`Opening project ${projectId}... - Game.js:2209`);
  ...
  app.get("/api/assets", async (req, res) => {
    try {
      ...
      console.error('Asset scanning error: - Game.js:2300', error);
      res.status(500).json({ 
        success: false, 
  ...
  app.get("/api/engines/status", async (req, res) => {
    ...
    try {
      ...
      console.error('Engine detection error: - Game.js:2387', error);
