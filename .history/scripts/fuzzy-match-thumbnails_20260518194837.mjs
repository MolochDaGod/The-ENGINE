...
async function main() {
  ...
  console.log(
    `\nFixed: ${fixed}  (exact=${fixedByLayer.exact}, compact=${fixedByLayer.compact}, prefix=${fixedByLayer.prefix}; via-fallback=${fixedByFallback}, via-cross-repo=${fixedByCrossRepo})`,
  );
