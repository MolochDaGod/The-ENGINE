...
export const FLEET_REGISTRY: FleetRegistryEntry[] = [
  ...
  },
  {
    ...
    canonicalUrl: "https://nexus-nemesis-game.vercel.app",
    status: "live",
    authRequired: true,
    tags: ["pvp", "solo"],
    forge: true,
  ...
  },
  {
    id: "polyfighter",
    name: "Grudge Fighter",
    description: "3D fighting with character creator, level editor, HD city stages, voxel characters, trimesh combat.",
  ...
  },
  {
    id: "grudge-fighter",
    name: "Grudge Fighter",
    description: "Alias for polyfighter portal route.",
    canonicalUrl: "/polyfighter",
    status: "beta",
    tags: ["pvp", "solo", "arena"],
  },
