...
const _PORTAL_PRODUCTS_RAW = [
  ...
  },
  {
    ...
    section: "play",
    external: true,
    note: "Preview only — *.vercel.app, no custom domain",
  ...
  },
  {
    ...
    name: "Grudge Smash",
    href: "/polyfighter",
    description: "2D Smash-style platform fighter — sprite warriors, AI opponents, online PvP, and super attacks.",
    status: "live",
    section: "play",
    tags: ["pvp", "solo", "arena"],
  ...
  {
    id: "grudge-studio-client",
    name: "Grudge Studio Client",
    href: "https://client.grudge-studio.com",
    description: "The Grudge Studio client portal — gateway to grudgewarlords.com with character creation and crafting.",
    status: "live",
    section: "featured",
    external: true,
    authRequired: true,
  ...
  },
  {
    ...
    description: "Season 0 TCG — 102 card templates, deckbuilder, ranked PvP via Socket.IO, pack redemption. Railway fullstack (Express + Vite + Postgres).",
    status: "live",
    section: "play",
    external: true,
    authRequired: true,
    note: "Production at nemesis.grudge-studio.com",
    tags: ["pvp", "solo"],
  ...
  },
  {
    ...
    external: true,
    authRequired: true,
    note: "Preview only — latest production was ERROR after Nexus PR 22. Keep *.vercel.app, not production.",
    tags: ["pvpve", "coop", "rts"],
  ...
  },
  {
    ...
    name: "Grudge Smash",
    href: "/polyfighter",
    description: "2D Smash-style platform fighter (same title as /polyfighter) — sprite combat, AI, online PvP.",
    status: "live",
    section: "play",
    tags: ["solo", "pvp", "arena"],
