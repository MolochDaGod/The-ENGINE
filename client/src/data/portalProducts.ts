...
const _PORTAL_PRODUCTS_RAW = [
  ...
  },
  {
    ...
    description: "Season 0 TCG — 100K cNFT cards on Solana via Crossmint. 102 card templates, deckbuilder, ranked PvP via Socket.IO, pack redemption. Railway fullstack (Express + Vite + Postgres).",
    status: "live",
    section: "play",
    external: true,
    authRequired: true,
