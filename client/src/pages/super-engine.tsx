...
const ENGINE_TABLE: EngineRow[] = [
  { name: 'R3F + Rapier', rendering: '3D WebGL', physics: true, multiplayer: true, ai: true, particles: true, scriptLanguage: 'TypeScript', platforms: 'Web, Mobile' },
  { name: 'Three.js + Cannon-ES', rendering: '3D WebGL', physics: true, multiplayer: false, ai: true, particles: true, scriptLanguage: 'TypeScript', platforms: 'Web, Mobile' },
  { name: 'BabylonJS + Havok', rendering: '3D WebGL', physics: true, multiplayer: false, ai: true, particles: true, scriptLanguage: 'TypeScript', platforms: 'Web, Mobile' },
  { name: 'Three.js + D1/R2', rendering: '3D WebGL', physics: true, multiplayer: false, ai: false, particles: true, scriptLanguage: 'TypeScript', platforms: 'Web' },
  { name: 'Three.js + Socket.IO', rendering: '3D WebGL', physics: true, multiplayer: true, ai: true, particles: true, scriptLanguage: 'TypeScript', platforms: 'Web, Mobile' },
