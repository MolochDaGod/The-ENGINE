...
const GAMES: GameCard[] = [
  ...
  },
  {
    ...
    description: 'Three.js + Cannon-ES + CharacterFSM. Maria GLTF with full combo FSM, capsule physics, animation blending, and RoleControls. The engine core for all Grudge 3D games.',
    type: '3D Engine Demo',
  ...
  },
  {
    id: 'mage-arena',
    name: 'Mage Arena',
    description: 'Hero-based arena combat with 4 mage classes. Solo survival, PvP deathmatch, and PvE co-op up to 4 players.',
    type: 'Arena PvP / Co-op',
    engine: 'Canvas 2D + WebSocket',
    route: '/mage-arena',
    emoji: '🔮',
    color: 'from-purple-900/60 to-violet-800/30',
    gradientBorder: 'from-purple-500 via-pink-500 to-red-500',
    icon: Swords,
    capabilities: ['2D', 'Multiplayer', 'Particles'],
    previewType: 'canvas2d',
  },
];
